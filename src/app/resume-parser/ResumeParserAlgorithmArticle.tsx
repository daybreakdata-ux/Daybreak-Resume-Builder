  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the Daybreak Resume Builder
      ...
      <Paragraph>
        And that is everything about the Daybreak Resume Builder parser algorithm :)
      </Paragraph>
      <Paragraph>
