...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Daybreak Resume Builder saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Daybreak Resume Builder apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Daybreak Resume Builder, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Daybreak Resume Builder
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Daybreak Resume Builder is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Daybreak Resume Builder intentionally only offers
          ...
          like references. Additionally, Daybreak Resume Builder only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Daybreak Resume Builder is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Daybreak Resume Builder believes that resume data should
          remain private and accessible only on user's local machine. Therefore,
          Daybreak Resume Builder doesn't require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created Daybreak Resume Builder and why?",
    answer: (
      <p>
        Daybreak Resume Builder was created by{" "}
        ...
        that led to Daybreak Resume Builder, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Daybreak Resume Builder can help
  ...
  {
    question: "Q4. How can I support Daybreak Resume Builder?",
    answer: (
      <>
        <p>
          The best way to support Daybreak Resume Builder is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:hello@daybreak-resume.com">hello@daybreak-resume.com</Link>{" "}
          or{" "}
        ...
        <p>
          Another great way to support Daybreak Resume Builder is by spreading the words.
